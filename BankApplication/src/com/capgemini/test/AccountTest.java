...
@Test
public void whenTheValidInfoIsPassedAccountShouldBeDeposited() throws InvalidAccountNumberException{
	Account account=new Account();
	account.setAccountNumber(101);
	account.setAmount(1000);
	when(accountRepository.searchAccount(account.getAccountNumber())).thenReturn(account);
	assertEquals(account.accountServiceWithdrawAmount(101,1000));
